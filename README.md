...
* Tokens give the user authorization to be on a protected page.

- [ ] What steps can you take in your web apps to keep your data secure?

* Try to avoid plain text credentials.

- [ ] Describe how web servers work.

* Servers receive requests from clients then return the data requested.
